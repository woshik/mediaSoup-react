    ...
    <React.Fragment>
      <AppBar
        ...
        className={classnames(
          ...
          !(isMobile || drawerOverlayed) && toolAreaOpen ? classes.persistentDrawerOpen : null
        )}
      >
        <Toolbar className="is-gradient">
          <PulsingBadge color="secondary" badgeContent={unread} onClick={() => toggleToolArea()}>
            <IconButton
              color="inherit"
          ...
          <div className={classes.sectionDesktop}>
            ...
            >
              <IconButton
                aria-owns={isMenuOpen && currentMenu === 'moreActions' ? 'material-appbar' : undefined}
                aria-haspopup
            ...
            {lobbyPeers.length > 0 && (
              ...
              >
                <span className={classes.disabledButton}>
                  ...
                  >
                    <PulsingBadge color="secondary" badgeContent={lobbyPeers.length}>
                      <SecurityIcon />
                    </PulsingBadge>
                  </IconButton>
                </span>
          ...
          <div className={classes.sectionMobile}>
            ...
            <IconButton aria-haspopup onClick={handleMobileMenuOpen} color="inherit">
              <MoreIcon />
            </IconButton>
          </div>
      ...
      >
        {loginEnabled && (
          ...
          >
            {myPicture ? <Avatar src={myPicture} /> : <AccountCircle className={loggedIn ? classes.green : null} />}
            {loggedIn ? (
              <p className={classes.moreAction}>
        ...
        >
          <ExtensionIcon />
          <p className={classes.moreAction}>
            <FormattedMessage id="label.moreActions" defaultMessage="More actions" />
          </p>
        </MenuItem>
      </Menu>
    </React.Fragment>
